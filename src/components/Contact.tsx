    ...
    <section id="contact" className="relative py-24 lg:py-32">
      ...
      <div ref={ref} className={`reveal ${visible ? 'visible' : ''}`}>
        <div className="mx-auto max-w-[1700px] px-8 lg:px-16">
          ...
          <p className="mb-10 max-w-lg text-sm leading-relaxed text-zinc-600">
            如果你对我的项目感兴趣，或有合适的工作机会，欢迎联系。
          </p>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <div className="min-w-0">
                <h3 className="text-sm font-medium text-zinc-400">GitHub</h3>
                <p className="truncate text-xs text-zinc-600">github.com/carpentist</p>
              </div>
